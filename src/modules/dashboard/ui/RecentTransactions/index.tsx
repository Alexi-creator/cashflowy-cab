...
import { useRecentTransactions } from "@/modules/transactions/api/useRecentTransactions"
import { formatTxAmount } from "@/modules/transactions/lib/helpers"
...
export function RecentTransactions() {
  ...
  const { data, isLoading, isError } = useRecentTransactions(RECENT_LIMIT)
