...
import { z } from "zod"
import { useRequestPasswordReset } from "@/modules/auth/api/useRequestPasswordReset"
import { useResendEmailConfirmation } from "@/modules/auth/api/useResendEmailConfirmation"
import { useSaveCredentials } from "@/modules/auth/api/useSaveCredentials"
...
export function SecurityForm() {
  ...
  const mutation = useSaveCredentials({
    onSuccess: () => {
      setEmail("")
      setCurrentPassword("")
      setPassword("")
        ...
        <>
          ...
          <Group justify="flex-end">
            <Button
              onClick={() =>
                mutation.mutate({
                  ...(canLinkEmail ? { email: trimmedEmail, linkedEmail: trimmedEmail } : {}),
